...
<section class="container-fluid widgets-content section-county">
	<div class="container">
		<div class="row">
			<h3 class="text-center col-xs-12">Find a Clinic for Treatments Popular</h3>
			<div class="col-xs-12">
				<div class="row county-row treatments-row">
					<?php  
						for ($i=0; $i < $count_treatment ; $i++) {
							if ($popular < 8 ){
								if ($treatments[$i]['popular'] == 'yes' || $treatments[$i]['popular'] == 'on' ) { 
									if ($treatments[$i]['img'] == '') {
